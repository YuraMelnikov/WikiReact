      ...
      <Row>
        ...
        <Col md={6}>
          <Card>
            ...
            <CardBody>
              <InputGroup>
                <InputGroupAddon addonType="prepend"><Button>Im a button</Button></InputGroupAddon>
                <Input />
              </InputGroup>
              <br />
              <InputGroup>
              ...
              <InputGroup>
                ...
                <Input placeholder="and..." />
                <InputGroupAddon addonType="append"><Button color="secondary">Im a button</Button></InputGroupAddon>
              </InputGroup>
            </CardBody>
          </Card>
        </Col>
